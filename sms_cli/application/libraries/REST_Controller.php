...
class REST_Controller extends CI_Controller {
    ...
    protected $method = NULL; // Stores accept, language, body, headers, etc
    ...
    public function __construct()
    {
        ...
        $res = (object)array("method" => $method); // object(stdClass)
        $this->request = $res;
        ...
        switch ($this->request->method)
        {
            ...
            case 'post':
                ...
                $this->_post_args = $_POST = json_decode($this->request->body, true); 
                break;
